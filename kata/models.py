...
class Projects(models.Model):
	...
	members = models.ManyToManyField('KataUser', related_name='+', verbose_name='Anggota Tim', limit_choices_to= {'is_staff' : False})
	## Project Tasks
	tasks   = models.ManyToManyField('Tasks', related_name='+', verbose_name='Pekerjaan Terkait', blank=True)
